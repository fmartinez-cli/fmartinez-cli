...
🌐 **Network Engineering** |🌐 **CCNA Certified** |🧠 **Problem Solver** | 🛠️ **Automation · AI · Agile** 

My specialty is not a single technology—it's **solving complex problems**.

Passionate about networking, but with a multidisciplinary approach: programming, automation, agile methodologies, and the wisdom to know when to ask for help. When facing a challenge—whether hardware, software, or people—I use **every** available tool, without limiting myself to labels.

> *"I'm not a network engineer who codes. I'm an engineer who solves problems—using networks, code, and methodologies to get there."*

## 🛠️ Tech Stack

**Networking**  
![Cisco CCNA](https://img.shields.io/badge/Cisco_CCNA-1BA0D7?style=flat&logo=cisco&logoColor=white) TCP/IP · VLANs · Routing & Switching · Network Diagnostics

**Full Stack (LAMP)**  
![Linux](https://img.shields.io/badge/-Linux-FCC624?style=flat&logo=linux&logoColor=black) ![Apache](https://img.shields.io/badge/-Apache-D22128?style=flat&logo=apache&logoColor=white) ![MySQL](https://img.shields.io/badge/-MySQL-4479A1?style=flat&logo=mysql&logoColor=white) ![PHP](https://img.shields.io/badge/-PHP-777BB4?style=flat&logo=php&logoColor=white) HTML/CSS · JavaScript

**Programming & Automation**  
![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white) ![Java](https://img.shields.io/badge/-Java-ED8B00?style=flat&logo=openjdk&logoColor=white) ![Bash](https://img.shields.io/badge/-Bash-4EAA25?style=flat&logo=gnu-bash&logoColor=white) SQL · CLI Tools · Zenity · FTP Automation

**Methodologies & Leadership**  
![Agile](https://img.shields.io/badge/-Agile-007396?style=flat) ![KANBAN](https://img.shields.io/badge/-KANBAN-0052CC?style=flat) Lean · 5S · KAIZEN · Team Leadership · Problem Solving Under Pressure
